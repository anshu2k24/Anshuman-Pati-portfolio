...
export default function Footer() {
  return (
    <footer className="py-7 border-t border-gray-200 bg-gradient-to-br from-white to-gray-50 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-t from-blue-50/30 to-transparent"></div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          <div className="mb-6">
            <p className="text-2xl font-bold bg-clip-text text-purple-500 mb-2">Just Anshu 😎</p>
          </div>
