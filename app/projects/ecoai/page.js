  ...
  const features = [
    {
      ...
      description:
        "AI-powered algorithms compress and refine your prompts, removing redundancy while preserving core intent.",
    },
    {
      icon: <ScaleIcon />,
      title: "Reduced Token Consumption",
      description:
        "Significantly lower your API costs by sending shorter, more efficient prompts to the LLM.",
    },
    {
      icon: <BoltIcon />,
      title: "Faster Response Times",
      description:
        "Less data to process means quicker inference, leading to a snappier, more responsive user experience.",
    },
    {
      icon: <CpuChipIcon />,
      title: "Energy-Efficient Inference",
      description:
        "Minimize the computational load for each query, directly contributing to a lower energy footprint.",
    },
  ];
    ...
    <div className="bg-gradient-to-br from-slate-50 via-emerald-50/30 to-slate-50">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-emerald-50/20 to-white">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-96 h-96 bg-green-400/10 rounded-full blur-3xl animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/2 w-96 h-96 bg-teal-400/5 rounded-full blur-3xl animate-pulse"
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl md:text-2xl text-slate-600 font-light leading-relaxed max-w-xl mx-auto lg:mx-0">
                  ...
                  <span className="font-semibold text-emerald-700">
                    {" "}
                    Cut costs, boost speed, save the planet.
                  </span>
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/80 backdrop-blur-xl p-6 rounded-2xl shadow-2xl ring-1 ring-slate-200/50 border border-white/20">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-sm md:text-xl font-bold text-slate-700 flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-slate-900">
              The Hidden Cost of{" "}
              <span className="text-red-600">Inefficiency</span>
            </h2>
            <p className="text-xl text-slate-600 leading-relaxed">
              Widespread generative AI adoption comes with a massive, invisible
              energy footprint. Every redundant word in a prompt translates to
              wasted computation, energy, and time—
      ...
      <section className="py-24 sm:py-32 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              EcoAi acts as a smart filter, ensuring that only the most
              efficient version of your prompt reaches the AI model.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl ring-1 ring-slate-200/50">
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                By promoting resource efficiency in the digital world, EcoAi
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-8 py-24 text-center">
          <div className="space-y-8">
            ...
            <p className="text-xl md:text-2xl text-emerald-50 max-w-2xl mx-auto leading-relaxed">
              Dive into the source code to see how it works or check back soon
              for a live interactive demo.{" "}
              <span className="font-semibold">Contributions are welcome!</span>
            </p>
